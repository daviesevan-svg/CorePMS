defmodule HospexWeb.Settings.Shared do
  ...
  def icon(%{name: :cog} = assigns),     do: ~H|<svg class={@class} viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="8" r="2.2"/><path d="M8 1.5v2M8 12.5v2M14.5 8h-2M3.5 8h-2M12.6 3.4 11.2 4.8M4.8 11.2l-1.4 1.4M12.6 12.6l-1.4-1.4M4.8 4.8 3.4 3.4"/></svg>|
  def icon(%{name: :edit} = assigns),    do: ~H|<svg class={@class} viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="m10 2.5 3.5 3.5L6 13.5H2.5V10l7.5-7.5Z"/><path d="m8.5 4 3.5 3.5"/></svg>|
  def icon(%{name: :map_pin} = assigns), do: ~H|<svg class={@class} viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M8 13.5s4.5-3.5 4.5-7a4.5 4.5 0 0 0-9 0c0 3.5 4.5 7 4.5 7Z"/><circle cx="8" cy="6.5" r="1.5"/></svg>|
  def icon(%{name: :phone} = assigns),   do: ~H|<svg class={@class} viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M3 3.5C3 3 3.4 2.5 4 2.5h1.5c.5 0 .9.3 1 .8l.5 2c.1.4 0 .8-.3 1.1L5.5 7.5c.8 1.5 2 2.7 3.5 3.5l1.1-1.2c.3-.3.7-.4 1.1-.3l2 .5c.5.1.8.5.8 1V12.5c0 .5-.5 1-1 1h-.5C7.7 13.5 2.5 8.3 2.5 4V3.5Z"/></svg>|
  def icon(%{name: :mail} = assigns),    do: ~H|<svg class={@class} viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="3.5" width="12" height="9" rx="1.5"/><path d="m2.5 5 5.5 4 5.5-4"/></svg>|
  def icon(%{name: :link} = assigns),    do: ~H|<svg class={@class} viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M7 9.5 9.5 7M6.5 4.5l1-1a2.5 2.5 0 0 1 3.5 3.5l-1 1M9.5 11.5l-1 1a2.5 2.5 0 0 1-3.5-3.5l1-1"/></svg>|
  def icon(%{name: :image} = assigns),   do: ~H|<svg class={@class} viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="2.5" y="3" width="11" height="10" rx="1.5"/><circle cx="6" cy="6.5" r="1.2"/><path d="m2.5 11 3-3 3 3 2-2 3 3"/></svg>|
  def icon(%{name: :wifi} = assigns),    do: ~H|<svg class={@class} viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M2 6a9 9 0 0 1 12 0M4 8.5a6 6 0 0 1 8 0M6 11a3 3 0 0 1 4 0"/><circle cx="8" cy="13" r=".8" fill="currentColor"/></svg>|
  def icon(%{name: :shield} = assigns),  do: ~H|<svg class={@class} viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M8 2.5 13 4v5c0 2.5-2.5 4.5-5 5-2.5-.5-5-2.5-5-5V4z"/></svg>|
  def icon(%{name: :receipt_tax} = assigns), do: ~H|<svg class={@class} viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M3.5 2v12l1.5-1 1.5 1 1.5-1 1.5 1 1.5-1 1.5 1V2z"/><path d="m6 9.5 4-4" stroke-width="2"/><path d="M6.5 6.5h.01M9.5 9.5h.01" stroke-width="2"/></svg>|
  def icon(%{name: :building} = assigns),do: ~H|<svg class={@class} viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M3 13.5V4l4.5-1.5V13.5M7.5 13.5h5.5V6L7.5 4.5M13 13.5H2.5M5 6.5h1M5 9h1M9.5 7.5h1.5M9.5 10h1.5"/></svg>|
  def icon(%{name: :star} = assigns),    do: ~H|<svg class={@class} viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M8 2.5 9.7 6l3.8.6-2.7 2.6.6 3.7L8 11.2l-3.4 1.7.6-3.7-2.7-2.6L6.3 6Z"/></svg>|
  def icon(%{name: :key} = assigns),     do: ~H|<svg class={@class} viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="5.5" cy="10.5" r="2.5"/><path d="m7.5 9 5-5M11 5.5l1.5 1.5M9 7.5 10.5 9"/></svg>|
  def icon(%{name: :users} = assigns),   do: ~H|<svg class={@class} viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="6" cy="6" r="2"/><path d="M2 13c0-2 1.8-3.5 4-3.5s4 1.5 4 3.5"/><path d="M10 6.5a1.7 1.7 0 0 0 0-3.4M11 13c0-1.5-.7-2.5-1.6-3.1"/></svg>|
  def icon(%{name: :bed} = assigns),     do: ~H|<svg class={@class} viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M2 12V5M14 12V8c0-1-.8-2-2-2H7v6M2 9.5h12M2 12h12"/><circle cx="5" cy="8.5" r="1"/></svg>|
  def icon(%{name: :card} = assigns),    do: ~H|<svg class={@class} viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="1.5" y="3.5" width="13" height="9" rx="1.5"/><path d="M1.5 7h13M3.5 10.5h2"/></svg>|
  def icon(%{name: :receipt} = assigns), do: ~H|<svg class={@class} viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M3.5 2v12l1.2-.8L6 14l1.2-.8L8.5 14l1.2-.8L11 14l1.5-.8V2Z"/><path d="M5.5 5.5h5M5.5 8h5M5.5 10.5h3"/></svg>|
  def icon(%{name: :cash} = assigns),    do: ~H|<svg class={@class} viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="1.5" y="4" width="13" height="8" rx="1.5"/><circle cx="8" cy="8" r="2"/></svg>|
  def icon(%{name: :help} = assigns),    do: ~H|<svg class={@class} viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="8" r="5.5"/><path d="M6.5 6.5a1.5 1.5 0 0 1 3 0c0 1-1.5 1.2-1.5 2.2M8 11.5h.01" stroke-width="2"/></svg>|
  def icon(%{name: :globe} = assigns),   do: ~H|<svg class={@class} viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="8" r="5.5"/><path d="M2.5 8h11M8 2.5c2 2 2 9 0 11M8 2.5c-2 2-2 9 0 11"/></svg>|
  def icon(%{name: :sparkles} = assigns),do: ~H|<svg class={@class} viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M8 2 9 6l4 1-4 1-1 4-1-4-4-1 4-1zM12.5 9 13 11l2 .5-2 .5-.5 2-.5-2-2-.5 2-.5z"/></svg>|
  def icon(%{name: :search} = assigns),  do: ~H|<svg class={@class} viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="7" cy="7" r="4"/><path d="m10 10 3 3"/></svg>|
  def icon(%{name: :upload} = assigns),  do: ~H|<svg class={@class} viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M8 11V3m0 0L5.5 5.5M8 3l2.5 2.5M3 12.5v.5a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1v-.5"/></svg>|
  def icon(%{name: :plus} = assigns),    do: ~H|<svg class={@class} viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M8 3v10M3 8h10"/></svg>|
  def icon(%{name: :check} = assigns),   do: ~H|<svg class={@class} viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="m3 8.5 3.5 3.5L13 5"/></svg>|
  def icon(%{name: :check_small} = assigns), do: ~H|<svg class={@class} viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m3.5 8 3 3 6-6.5"/></svg>|
  def icon(%{name: :undo} = assigns),    do: ~H|<svg class={@class} viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M5 6h6.5a2 2 0 0 1 0 4H8M5 6 7.5 3.5M5 6l2.5 2.5"/></svg>|
  def icon(%{name: :close} = assigns),   do: ~H|<svg class={@class} viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="m4 4 8 8M12 4l-8 8"/></svg>|
  def icon(%{name: :arrow_in} = assigns),do: ~H|<svg class={@class} viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M3 8h8m0 0L8.5 5.5M11 8 8.5 10.5"/></svg>|
  def icon(%{name: :arrow_out} = assigns), do: ~H|<svg class={@class} viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M13 8H5m0 0 2.5-2.5M5 8l2.5 2.5"/></svg>|
  def icon(%{name: :refund} = assigns),  do: ~H|<svg class={@class} viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M3 8a5 5 0 1 0 1.5-3.5M3 2v3h3"/></svg>|
  def icon(%{name: :ban} = assigns),     do: ~H|<svg class={@class} viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="8" r="5.5"/><path d="m4 4 8 8"/></svg>|
  def icon(%{name: :child} = assigns),   do: ~H|<svg class={@class} viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="6" r="1.7"/><path d="M5 13.5c0-1.8 1.4-3 3-3s3 1.2 3 3"/></svg>|
  def icon(%{name: :chev_left} = assigns), do: ~H|<svg class={@class} viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M10 3.5 5.5 8 10 12.5"/></svg>|
  def icon(%{name: :chev_right} = assigns), do: ~H|<svg class={@class} viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M6 3.5 10.5 8 6 12.5"/></svg>|
  def icon(%{name: :trash} = assigns),   do: ~H|<svg class={@class} viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M3 4h10M6.5 4V2.5h3V4M5 4l.5 9h5L11 4M7 7v4M9 7v4"/></svg>|
